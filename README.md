...
device. Android's cloud backup and device-to-device transfer are disabled. A restore verifies the
archive is coherent before touching anything, so a corrupt backup cannot destroy what you have.
