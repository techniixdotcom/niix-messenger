...
# those are used as-is. Anything missing is downloaded into ./.toolchain instead of touching
# anything system-wide, so this never needs sudo and never conflicts with an existing install.
