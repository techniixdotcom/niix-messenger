 ...
 * it required three physical devices and a lot of hope. Everything below is free of
...
object GroupMembershipPolicy {
     ...
     *
     * @param senderIsAdmin whether the sender is a *currently recorded* admin. Never take their
     *   word for it.
     * @param currentEpoch epoch of the state this device already holds.
     * @param incomingEpoch epoch claimed by the change.
     * @param currentMembers who this device believes is in the group.
     * @param incomingMembers who the change says should be in it.
     */
    fun evaluate(
