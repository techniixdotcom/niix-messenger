 ...
 *
 * This app  writes no logs anywhere. That protects the user, there is no file for
 ...
 *
 * On purpose in `core/model` with no Android or storage dependencies, so every layer can
