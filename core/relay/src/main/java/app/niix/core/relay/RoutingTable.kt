...
class RoutingTable(private val localNodeId: ByteArray, private val k: Int = RelayProtocol.KADEMLIA_K) {
    ...
    /** Node plus last-seen time. Not folded into NodeInfo because its equality is its identity,
     * and a timestamp in there would make two sightings look like two different nodes. */
