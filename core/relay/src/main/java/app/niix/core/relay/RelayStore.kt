...
class RelayStore(
 ...
 // Clamped to a minimum as well as a maximum. Zero or negative previously produced an
 // envelope that expired the moment it was stored, accepted, then immediately dropped,
 // with the sender told it was safely relayed.
        val clampedTtl = ttlMillis.coerceIn(
            RelayProtocol.MIN_RELAY_TTL_MILLIS,
            RelayProtocol.MAX_RELAY_TTL_MILLIS,
        )
