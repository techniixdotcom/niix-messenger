...
class ConversationManager(
 ...
 // checked against and the chain silently starts one transition late.
    ...
    /**
     * Marks one message read: starts its timer and sends the receipt.
     *
     * Separate from markConversationRead because with blur on, having a conversation open does
     * not mean anything in it was read. Starting every timer would expire messages nobody saw.
     */
