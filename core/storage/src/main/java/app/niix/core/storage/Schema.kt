...
object Schema {
    ...
    object OnionIdentity {
        const val TABLE = "onion_identity"
        const val COL_ID = "id"
    ...
    object GroupRemoteSenderKeys {
        const val TABLE = "group_remote_sender_keys"
        const val COL_CONVERSATION_ID = "conversation_id"
    ...
    object Messages {
        ...
        const val COL_DISAPPEAR_SECONDS = "disappear_seconds"
        const val COL_REPLY_TO_ID = "reply_to_id"
        const val COL_REVEALED = "revealed"
    }
    ...
    val DDL: List<String> = listOf(
        ...
        """.trimIndent(),
        """
        CREATE TABLE IF NOT EXISTS ${OnionIdentity.TABLE} (
            ${OnionIdentity.COL_ID} INTEGER PRIMARY KEY,
            ${OnionIdentity.COL_PRIVATE_KEY} BLOB NOT NULL
        )
        """.trimIndent(),
        """
        ...
        """.trimIndent(),
        """
        CREATE TABLE IF NOT EXISTS ${GroupRemoteSenderKeys.TABLE} (
            ${GroupRemoteSenderKeys.COL_CONVERSATION_ID} TEXT NOT NULL,
            ${GroupRemoteSenderKeys.COL_SENDER_ONION} TEXT NOT NULL,
            ${GroupRemoteSenderKeys.COL_DISTRIBUTION_ID} TEXT NOT NULL,
            PRIMARY KEY (${GroupRemoteSenderKeys.COL_CONVERSATION_ID}, ${GroupRemoteSenderKeys.COL_SENDER_ONION}, ${GroupRemoteSenderKeys.COL_DISTRIBUTION_ID})
        )
        """.trimIndent(),
        """
        ...
        CREATE TABLE IF NOT EXISTS ${Messages.TABLE} (
            ...
            ${Messages.COL_REPLY_TO_ID} TEXT,
            ${Messages.COL_REVEALED} INTEGER NOT NULL DEFAULT 0
        )
        """.trimIndent(),
    ...
    val COLUMN_MIGRATIONS: List<Pair<String, String>> = listOf(
        ...
        Messages.TABLE to "ALTER TABLE ${Messages.TABLE} ADD COLUMN ${Messages.COL_REPLY_TO_ID} TEXT",
        Messages.TABLE to "ALTER TABLE ${Messages.TABLE} ADD COLUMN ${Messages.COL_REVEALED} INTEGER NOT NULL DEFAULT 0",
    )
}
