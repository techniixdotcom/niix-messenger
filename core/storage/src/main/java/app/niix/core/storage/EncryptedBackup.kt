...
class EncryptedBackup internal constructor(
    ...
    /**
     * Confirms the attached backup contains every table the restore will read from.
     *
     * On purpose throws rather than returning a result: the caller's next action is
     * destructive, and a check whose failure can be ignored is not a check.
     */
