...
class SettingsActivity : SecureActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Back goes through the dispatcher, as in the other screens. The deprecated onBackPressed()
        // override is not called at all once predictive back is enabled, which would make the Back
        // gesture leave Settings from inside a section instead of returning to the category list.
            ...
            AlertDialog.Builder(this@SettingsActivity)
                ...
                .setPositiveButton(R.string.update_install) { _, _ ->
                    ...
                    if (startError != null) {
                        ...
                        // The install runs asynchronously and asks for confirmation, so the
                        // outcome arrives later via UpdateInstallReceiver. Show the reason Android
                        // gave rather than leaving only the system installer's generic message.
