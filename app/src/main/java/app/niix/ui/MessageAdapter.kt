...
class MessageAdapter(
    ...
    /**
     * Incoming messages the user has tapped to reveal.
     *
     * Held in memory rather than persisted, so everything is blurred again the next time the
     * app starts. Persisting it would mean a device left unlocked shows the entire history in
     * the clear, which is the situation the feature exists for.
     */
