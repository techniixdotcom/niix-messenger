...
class KmpTorTransport(
    ...
    /**
     * Tor's cache directory,  under filesDir, not cacheDir.
     *
 ...
 // socket until the process dies.
    ...
    companion object {
        /** How long an inbound connection may stall mid-read before it is dropped. Long
         * enough for a genuine slow Tor circuit, short enough that idle connections cannot
         * accumulate. */
