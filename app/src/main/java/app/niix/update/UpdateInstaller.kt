...
object UpdateInstaller {
 ...
 // than committing a partial APK and failing later with a parse error.
                ...
                // Addressed to the one receiver that handles it, not only to this package. The
                // intent is mutable (the system writes the status into it), and a mutable intent
                // should name exactly where it goes.
                val intent = Intent(ACTION_INSTALL_STATUS)
                    .setPackage(context.packageName)
                    .setClass(context, UpdateInstallReceiver::class.java)
