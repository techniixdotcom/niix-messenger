...
android {
    ...
    defaultConfig {
        ...
        // Android 10. Raised from 26 so the app can use scoped storage properly: saving a file
        // to Downloads below this needs WRITE_EXTERNAL_STORAGE, which grants read and write
        // access to all shared storage and shows prominently in the permission list. Holding a
        // permission that broad, in an app whose value is restraint about what it can reach, is
        // a worse trade than dropping support for releases that are already several years past
        // their last security update.
        minSdk = 29
        targetSdk = 35
