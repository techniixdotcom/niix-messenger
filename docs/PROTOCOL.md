...
Fetch proofs are timestamped rather than challenge-response. Replay is prevented by remembering
proofs, not by binding them to a relay-chosen nonce. A challenge-response exchange would be
stronger and requires a protocol revision.
